...
urlpatterns = [  # pylint: disable=C0103
    ...
    url(r'^api/program/([0-9]+)/log$',
        api.program_manage_log,
        name='program_manage_log'),
    url(r'^api/program/([0-9]+)/log/enable$',
        api.program_enable_logging,
        name='program_enable_logging'),
    url(r'^api/program/([0-9]+)/log/disable$',
        api.program_disable_logging,
        name='program_disable_logging'),
